      ...
      <div className="admin-main-header">
        <div className="admin-main-card">
          ...
          <div className="admin-card-count">
            {typeof usersCount === 'number' ? usersCount : 'N/A'}
          </div>
        ...
        <div className="admin-main-card">
          ...
          <div className="admin-card-count">
            {typeof postsCount === 'number' ? postsCount : 'N/A'}
          </div>
          <div className="admin-card-link-wrapper">
            <Link
        ...
        <div className="admin-main-card">
          ...
          <div className="admin-card-count">
            {typeof categories.length === 'number' ? categories.length : 'N/A'}
          </div>
          <div className="admin-card-link-wrapper">
            <Link
        ...
        <div className="admin-main-card">
          ...
          <div className="admin-card-count">
            {typeof comments.length === 'number' ? comments.length : 'N/A'}
          </div>
          <div className="admin-card-link-wrapper">
            <Link
